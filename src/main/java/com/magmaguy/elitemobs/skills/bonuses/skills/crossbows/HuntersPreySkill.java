...
public class HuntersPreySkill extends SkillBonus implements ConditionalSkill {
    ...
    public List<String> getLoreDescription(int skillLevel) {
        return List.of(
                "&7Bonus Damage: &f" + String.format("%.1f", getConditionalBonus(skillLevel) * 100) + "%",
    ...
    @Override
    public String getFormattedBonus(int skillLevel) { return String.format("+%.1f%% to low HP targets", getConditionalBonus(skillLevel) * 100); }
    @Override
