...
public class SpawnElitePowers extends AdvancedCommand {
    public SpawnElitePowers() {
        super(List.of("spawn"));
        addLiteral("elite");
        ...
        setDescription("Spawns an elite of the specified type and level with the specified powers.");
    }
