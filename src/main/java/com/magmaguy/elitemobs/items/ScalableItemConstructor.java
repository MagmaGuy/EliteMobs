...
public class ScalableItemConstructor {
     ...
     */
    public static HashMap<ItemStack, List<HashMap>> fullyScalableItems = new HashMap();

    /*
    Limited scalable items can be of any tier up to the defined configuration presets
     */
    public static HashMap<ItemStack, List<HashMap>> limitedScalableItems = new HashMap();
