...
public final class ExperimentalMagicWeaponItems {
    public static final String STAFF_ITEM_ID = "experimental_arcane_staff";
    public static final String WAND_ITEM_ID = "experimental_arcane_wand";
    ...
    private ExperimentalMagicWeaponItems() {
    }
    ...
    private static CustomItemsConfigFields staff() {
        CustomItemsConfigFields fields = new CustomItemsConfigFields(
                ...
                true,
                staffMaterial(),
                "<gradient:#76EFC4:#00C96E:#0A7A44>Experimental Staff of Wonders</gradient>",
                List.of(
    ...
    private static CustomItemsConfigFields wand() {
        CustomItemsConfigFields fields = new CustomItemsConfigFields(
                ...
                true,
                Material.BLAZE_ROD,
                "<gradient:#D9B8FF:#8A5CFF>Experimental Arcane Wand</gradient>",
                List.of(
