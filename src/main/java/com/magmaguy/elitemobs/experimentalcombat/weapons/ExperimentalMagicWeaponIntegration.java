 ...
 */
public final class ExperimentalMagicWeaponIntegration implements Listener, AutoCloseable {
    ...
    public ExperimentalMagicWeaponIntegration(Plugin plugin) {
    ...
    private synchronized void scheduleReadinessWarning() {
        ...
        readinessWarningTask = Bukkit.getScheduler().runTaskLater(plugin, () -> {
            synchronized (ExperimentalMagicWeaponIntegration.this) {
