...
public class WoodLeagueArena extends CustomArenasConfigFields {
    public WoodLeagueArena() {
        ...
        super.setArenaMessages(new ArrayList<>(Arrays.asList(
                ...
                "wave=42:message=&8[Gladius] &fA wealthy for now patron has decided to throw in free healthcare to arena enemies! Will the enemies do better with &2healing&f?",
                ...
                "wave=47:message=&8[Gladius] &fIf swarms don't work, throw in &mcore powers&f! Throw in all of the powers!",
                ...
                "wave=50:message=&8[Gladius] &fI guess this is it for me... I have no option but to declare - wait, who is that in the distance? Is that &4Uther, the Champion of the Wood League Arena&f? Ladies and gentlemen, match set and over, our contestant has no chance of winning here! The shall be &csmitten &fby our champion!",
