...
public class WoodLeagueArena extends CustomArenasConfigFields {
    public WoodLeagueArena() {
        ...
        super.setRawArenaRewards(Arrays.asList(
                ...
                "currencyAmount=15:wave=2",
                "currencyAmount=30:wave=3",
                "currencyAmount=45:wave=4",
                "currencyAmount=60:wave=5",
                "currencyAmount=75:wave=6",
                "currencyAmount=90:wave=7",
                "currencyAmount=105:wave=8",
                "currencyAmount=120:wave=9",
                "currencyAmount=135:wave=10",
                "currencyAmount=150:wave=11",
                "currencyAmount=165:wave=12",
                "currencyAmount=180:wave=13",
                "currencyAmount=195:wave=14",
                "currencyAmount=210:wave=15",
                "currencyAmount=225:wave=16",
                "currencyAmount=240:wave=17",
                "currencyAmount=255:wave=18",
                "currencyAmount=270:wave=19",
                "currencyAmount=285:wave=20",
                "currencyAmount=300:wave=21",
                "currencyAmount=315:wave=22",
                "currencyAmount=330:wave=23",
                "currencyAmount=345:wave=24",
                "currencyAmount=360:wave=25",
                "currencyAmount=375:wave=26",
                "currencyAmount=390:wave=27",
                "currencyAmount=405:wave=28",
                "currencyAmount=420:wave=29",
                "currencyAmount=435:wave=30",
                "currencyAmount=450:wave=31",
                "currencyAmount=465:wave=32",
                "currencyAmount=480:wave=33",
                "currencyAmount=495:wave=34",
                "currencyAmount=510:wave=35",
                "currencyAmount=525:wave=36",
                "currencyAmount=540:wave=37",
                "currencyAmount=555:wave=38",
                "currencyAmount=570:wave=39",
                "currencyAmount=585:wave=40",
                "currencyAmount=600:wave=41",
                "currencyAmount=615:wave=42",
                "currencyAmount=630:wave=43",
                "currencyAmount=645:wave=44",
                "currencyAmount=660:wave=45",
                "currencyAmount=675:wave=46",
                "currencyAmount=690:wave=47",
                "currencyAmount=705:wave=48",
                "currencyAmount=720:wave=49",
                "currencyAmount=800:wave=50",

                "level=10:filename=summon_merchant_scroll.yml:wave=10",

                "filename=invictus_sword.yml:itemlevel=50:wave=50",
                "filename=invictus_helmet.yml:itemlevel=50:wave=50",
                "filename=invictus_chestplate.yml:itemlevel=50:wave=50",
                "filename=invictus_leggings.yml:itemlevel=50:wave=50",
                "filename=invictus_boots.yml:itemlevel=50:wave=50",
                "filename=invictus_pickaxe.yml:itemlevel=50:wave=50:chance=0.2",
                "filename=invictus_shovel.yml:itemlevel=50:wave=50:chance=0.2",

                "filename=challengers_sword.yml:itemlevel=40:wave=40",
                "filename=challengers_helmet.yml:itemlevel=40:wave=40",
                "filename=challengers_chestplate.yml:itemlevel=40:wave=40",
                "filename=challengers_leggings.yml:itemlevel=40:wave=40",
                "filename=challengers_boots.yml:itemlevel=40:wave=40",

                "filename=veterans_sword.yml:itemlevel=30:wave=30",
                "filename=veterans_helmet.yml:itemlevel=30:wave=30",
                "filename=veterans_chestplate.yml:itemlevel=30:wave=30",
                "filename=veterans_leggings.yml:itemlevel=30:wave=30",
                "filename=veterans_boots.yml:itemlevel=30:wave=30",

                "filename=grunts_sword.yml:itemlevel=20:wave=20",
                "filename=grunts_helmet.yml:itemlevel=20:wave=20",
                "filename=grunts_chestplate.yml:itemlevel=20:wave=20",
                "filename=grunts_leggings.yml:itemlevel=20:wave=20",
                "filename=grunts_boots.yml:itemlevel=20:wave=20",

                "filename=novices_sword.yml:itemlevel=10:wave=10",
                "filename=novices_helmet.yml:itemlevel=10:wave=10",
                "filename=novices_chestplate.yml:itemlevel=10:wave=10",
                "filename=novices_leggings.yml:itemlevel=10:wave=10",
                "filename=novices_boots.yml:itemlevel=10:wave=10"
        ...
        super.setArenaMessages(new ArrayList<>(Arrays.asList(
                ...
                "wave=2:message=&8[Gladius] &fWould you look at that - they know how to flail their arms! That was just the warmup. Let's start putting on some pressure!",
                "wave=3:message=&8[Gladius] &fSo you think you know how to fight? Well this wave will turn on the &cheat&f! Ha ha ha ha ha!",
                "wave=4:message=&8[Gladius] &fAlright, I guess they can take the heat. Strap in, ladies and gentlemen! We might be in for a show!",
                "wave=5:message=&8[Gladius] &fI found this &cweird creature &foutside, and I thought putting it in the arena would be funny!",
                "wave=6:message=&8[Gladius] &fSeems like you can handle small groups of enemies just fine. Let's see how you do against a &cmild swarm&f!",
                "wave=7:message=&8[Gladius] &fSo you truly believe you stand a chance in the arena? We shall see...",
                ...
                "wave=13:message=&8[Gladius] &fWhat's this? The arena custodians have elected to liven things up by coating the creatures with &2poison&f! Sounds a bit ironic if you ask me...",
                ...
                "wave=16:message=&8[Gladius] &fMr. Oinkers is now bacon! Here come &cMr. Oinkers' fans&f, flooding the arena to get their revenge!",
                "wave=17:message=&8[Gladius] &fOur arena challenger seems to think they have a shot at victory! But can they handle even &cmore powerful &ffoes?",
                "wave=18:message=&8[Gladius] &fThe &cfencing club &fand the &carchery club &fare having a contest! Let's see which group can take down the challenger!",
                "wave=19:message=&8[Gladius] &fThe fencing club has been has been beat into submission. Let's see what the &carchery club&f has for us!",
                "wave=20:message=&8[Gladius] &fThe archery club also missed the mark! It seems like our challenger has begun attracting the attention of some of our top gladiators! Introducing &2Zoltan, the Pride of the Zombies&f!",
                "wave=21:message=&8[Gladius] &fUnbelievable! Zoltan has been lobotomized! Do we have a potential new champion on our hands?",
                "wave=22:message=&8[Gladius] &fSpectators are starting to place their bets! How far can today's contestant go?",
                "wave=23:message=&8[Gladius] &fDon't let your attention &8wither &faway, this wave's enemies all have &cwithering attacks&f!",
                "wave=24:message=&8[Gladius] &fWe're seeing some of the biggest names in arena history emerge to put an end to this challenger's winning streak! Stay tuned!",
                ...
                "wave=27:message=&8[Gladius] &fThe arena necromancers are putting their latest creations to the test! &cZombies immune to arrows, skeletons that freeze their opponents &f- what will they think of next!?",
                "wave=28:message=&8[Gladius] &fIt's time to show off those &cfencing &fskills! Remember, it's all about the legwork!",
                "wave=29:message=&8[Gladius] &fAnd now, let's have some &ctarget practice&f! The target is the challenger!",
                "wave=30:message=&8[Gladius] &fA true arena champion approaches! The &2Southern Viper &fseeks to use his trademark &cthousand venoms&f to consign foes to an agonizing death!",
                ...
                "wave=35:message=&8[Gladius] &fLadies and gentlemen, what a rare treat! The &aWood League Jester &fhas taken the stage! What delightful &ctricks &fdoes he have for us today?",
                ...
                "wave=38:message=&8[Gladius] &fBobby you're killing me here! Uh, dump some &cswordsmen &fout there, I need to deal with something real quick...",
                "wave=39:message=&8[Gladius] &fWhat do you mean no refunds? I didn't even want to - ahem, I mean, a legion of &carchers &fhave come from afar to show off their skills!",
                "wave=40:message=&8[Gladius] &fLadies and gentlemen, as an act of impartial, honest showmanship, I have invited the strongest fighter I can summon! Meet &4Crucios, the Bearer of Curses&f!",
                "wave=41:message=&8[Gladius] &fCrucios has been defeated!? What has the world come to?",
                "wave=42:message=&8[Gladius] &fA wealthy (for now) patron has decided to provide free healthcare to arena enemies! Will they do better with &2healing&f?",
                ...
                "wave=44:message=&8[Gladius] &fThis is clearly not working. Give me a moment to think of something...",
                ...
                "wave=46:message=&8[Gladius] &fThousand Blades has been broken! It just seems like you can't get competent gladiators these days! That's fine, you'll see! You'll all see! &cRelease the horde!",
                "wave=47:message=&8[Gladius] &fThey're still standing! Throw in &cmore powers&f! Throw in all of the powers!",
                "wave=48:message=&8[Gladius] &fWe're running low on options here! Send in all of the remaining &cswordsmen &f!",
                "wave=49:message=&8[Gladius] &fWe're scraping the bottom of the barrel... Send everything we have left! Move forth, &carchers&f!",
                "wave=50:message=&8[Gladius] &fI guess this is it for me... I have no option but to declare - wait, who is that in the distance? Is that &4Uther, the Champion of the Wood League Arena&f? Ladies and gentlemen, game, set, and match! Our contestant has no chance of victory here! They shall face &eeradication &fby our champion!",
                "wave=51:message=&8[Gladius the Destitute] &fUnbelievable, Uther has been vanquished! We have a new arena champion! I would be incredibly excited if I wasn't so terribly in debt now!"
        )));
