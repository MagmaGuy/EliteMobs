...
public class ItemsUniqueConfig {
    ...
    public static final String DEPTHS_SEEKER = ITEM_KEY + "Depths Seeker";
    public static final String ENABLE_GREED = "Enable Greed pickaxe";
    public static final String GREED = ITEM_KEY + "Greed";
    public static final String ENABLE_THE_FELLER = "Enable The Feller";
    public static final String THE_FELLER = ITEM_KEY + "The Feller";
