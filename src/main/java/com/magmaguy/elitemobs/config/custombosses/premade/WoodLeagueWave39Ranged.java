...
public class WoodLeagueWave39Ranged extends CustomBossesConfigFields {
    public WoodLeagueWave39Ranged() {
        super("wood_league_wave_39_ranged",
                EntityType.PILLAGER,
                true,
                "$normalLevel Arena Archer",
                "39");
