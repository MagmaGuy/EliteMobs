...
public class ChallengersChestplateConfig extends CustomItemsConfigFields {
    public ChallengersChestplateConfig() {
        super("challengers_chestplate", true, Material.DIAMOND_CHESTPLATE, "&cChallenger's Chestplate", new ArrayList<>(List.of("&2Awarded to those who challenge the", "&2Wood League Arena!")));
