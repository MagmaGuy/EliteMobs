...
public class InvictusChestplateConfig extends CustomItemsConfigFields {
    public InvictusChestplateConfig() {
        super("invictus_chestplate", true, Material.NETHERITE_CHESTPLATE, "<g:#FFD700:#FF4500>Invictus Chestplate</g>", new ArrayList<>(List.of("&2Awarded to the champions of the", "&2Wood League Arena!")));
