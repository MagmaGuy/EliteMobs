...
public class ChallengersLeggingsConfig extends CustomItemsConfigFields {
    public ChallengersLeggingsConfig() {
        super("challengers_leggings", true, Material.DIAMOND_LEGGINGS, "<g:#DC143C:#FF6347>Challenger's Leggings</g>", new ArrayList<>(List.of("&2Awarded to those who challenge the", "&2Wood League Arena!")));
