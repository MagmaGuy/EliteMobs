...
public class InvictusBootsConfig extends CustomItemsConfigFields {
    public InvictusBootsConfig() {
        super("invictus_boots", true, Material.NETHERITE_BOOTS, "<g:#FFD700:#FF4500>Invictus Boots</g>", new ArrayList<>(List.of("&2Awarded to the champions of the", "&2Wood League Arena!")));
