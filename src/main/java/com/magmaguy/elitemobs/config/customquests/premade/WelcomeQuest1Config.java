...
public class WelcomeQuest1Config extends CustomQuestsConfigFields {
    public WelcomeQuest1Config() {
        ...
        super.customObjectives.put("Objective7", Map.of("objectiveType", "DIALOG", "filename", "enchanter_config.yml", "npcName", "Eden", "location", "under the main building", "dialog", List.of("&8[&aEden&8]&f Need to enchant your Elite items? Just bring me an elite enchanted book!")));
