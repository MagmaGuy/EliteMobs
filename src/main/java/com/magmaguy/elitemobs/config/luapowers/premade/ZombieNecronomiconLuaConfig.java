...
public class ZombieNecronomiconLuaConfig extends LuaPowersConfigFields {
    private static final String SUMMONING_CHANT = "Nor is it to be thought..."
    ...
    public ZombieNecronomiconLuaConfig() {
        super("zombie_necronomicon", Material.ENCHANTED_BOOK.toString(), PowersConfigFields.PowerType.MAJOR_ZOMBIE);
    }

    @Override
    public String getSource() {
        return """
                local summoning_chant = %s
                ...
                return {
                  ...
                  on_boss_damaged_by_player = function(context)
                    ...
                    context.boss:start_zombie_necronomicon(context.player, summoning_chant)
                  end
                }
                """.formatted(luaQuote(SUMMONING_CHANT));
    }
}
