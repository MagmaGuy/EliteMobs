...
public class AttackFireballLuaConfig extends LuaPowersConfigFields {
    public AttackFireballLuaConfig() {
        super("attack_fireball", Material.FIRE_CHARGE.toString(), PowersConfigFields.PowerType.OFFENSIVE);
    }
