...
public class ZombieParentsConfig extends PowersConfigFields {
    ...
    public void processAdditionalFields() {
        deathMessage = ConfigurationEngine.setList(file, fileConfiguration, "deathMessage", new ArrayList<>(List.of(
                "You monster!",
                "My baby!",
                "What have you done!?",
                "Revenge!",
        ...
        bossEntityDialog = ConfigurationEngine.setList(file, fileConfiguration, "bossEntityDialog", new ArrayList<>(List.of(
        ...
        zombieDad = ConfigurationEngine.setList(file, fileConfiguration, "zombieDad", new ArrayList<>(List.of(
        ...
        zombieMom = ConfigurationEngine.setList(file, fileConfiguration, "zombieMom", new ArrayList<>(List.of(
                "Hands off my child!",
