...
import static com.magmaguy.elitemobs.config.ConfigInitializer.setInt;
import static com.magmaguy.elitemobs.config.ConfigInitializer.setString;
...
public class BuyOrSellMenuConfig extends MenusConfigFields {
    ...
    public FileConfiguration generateConfigDefaults(FileConfiguration fileConfiguration) {
        SHOP_NAME = setString(fileConfiguration, "Shop name", "[EM] Custom Item Shop");
        ...
        INFORMATION_SLOT = setInt(fileConfiguration, "Information button slot", 4);
        ...
        BUY_SLOT = setInt(fileConfiguration, "&a&lBuy slot", 11);
        SELL_SLOT = setInt(fileConfiguration, "&c&lSell slot", 15);
