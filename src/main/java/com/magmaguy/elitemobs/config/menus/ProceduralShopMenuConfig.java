...
public class ProceduralShopMenuConfig extends MenusConfigFields {
    ...
    public FileConfiguration generateConfigDefaults(FileConfiguration fileConfiguration) {
        SHOP_NAME = setString(fileConfiguration, "Shop name", "[EM] Procedural Item Shop");
        ...
        MIN_TIER = setInt(fileConfiguration, "Minimum store item tier", 0);
        MAX_TIER = setInt(fileConfiguration, "Maximum store item tier", 5);
