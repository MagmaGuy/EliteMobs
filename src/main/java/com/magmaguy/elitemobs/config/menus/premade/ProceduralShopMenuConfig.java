...
public class ProceduralShopMenuConfig extends MenusConfigFields {
    ...
    public static int MIN_TIER, MAX_TIER;
    ...
    public FileConfiguration generateConfigDefaults(FileConfiguration fileConfiguration) {
        SHOP_NAME = ConfigurationEngine.setString(fileConfiguration, "Shop name", "[EM] Procedural Item Shop");
        ...
        MIN_TIER = ConfigurationEngine.setInt(fileConfiguration, "Minimum store item tier", 0);
        MAX_TIER = ConfigurationEngine.setInt(fileConfiguration, "Maximum store item tier", 5);
