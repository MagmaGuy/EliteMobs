...
public final class EnchantmentDamage {
    ...
    public static void apply(UUID attackId, Map<String, ItemStack> capturedEquipment, Runnable application) {
        ...
        double threatBonus = capturedEquipment.values().stream().mapToDouble(PlayerItem::readLoudStrikesBonus).sum();
