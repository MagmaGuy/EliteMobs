...
class MagicWeaponProgressionTest {
    ...
    void fmmWeaponFamiliesBindToTheirOwnProgressionSkills() {
        ...
        assertEquals("fmm_default_arcane_staff", AdvancedMagicWeaponItems.STAFF_FMM_ITEM_ID);
        assertEquals("fmm_default_arcane_wand", AdvancedMagicWeaponItems.WAND_FMM_ITEM_ID);
    }
    ...
    void fullDebugLoadoutNamesBothRegisteredScalableItems() {
        assertEquals(
                java.util.List.of(
                        AdvancedMagicWeaponItems.STAFF_ITEM_ID,
                        AdvancedMagicWeaponItems.WAND_ITEM_ID),
                AdvancedMagicWeaponItems.debugLoadoutIds());
    }
