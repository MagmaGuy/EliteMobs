...
public class ZombieFriends extends MajorPowers implements Listener {
    ...
    public void onHit(EntityDamageEvent event) {
        ...
        if (event.getEntity().hasMetadata(powerMetadata) && event.getEntity() instanceof Zombie &&
            ...
            friend1.setMetadata(MetadataHandler.FORBIDDEN_MD, new FixedMetadataValue(plugin, assistMobLevel));
            friend2.setMetadata(MetadataHandler.FORBIDDEN_MD, new FixedMetadataValue(plugin, assistMobLevel));
