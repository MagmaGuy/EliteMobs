...
public class SheepHandler implements Listener {
    ...
    public void superDrops(EntityDamageByEntityEvent event) {
        ...
        if (event.getEntity().hasMetadata(metadataHandler.passiveEliteMobMD) && event.getEntity() instanceof Sheep) {
    ...
    public void onDeath(EntityDeathEvent event) {
        ...
        if (event.getEntity() instanceof Sheep && event.getEntity().hasMetadata(metadataHandler.passiveEliteMobMD)) {
