...
public class SuperMobDamageHandler implements Listener{
    ...
    public static double damageMath (double initialDamage)
    {
        ...
        getLogger().info("Intial Damage: " + initialDamage);

        double finalDamage = (initialDamage * 80) / (initialDamage + 50);
    ...
    public void onHit(EntityDamageByEntityEvent event)
    {
        ...
        if (event.getEntity().hasMetadata("MagmasSuperMob") && event.getEntity() instanceof Player)
        {

            getLogger().info("Lol shit's broken yo.");
