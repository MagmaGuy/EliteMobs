 ...
 */
public class SuperDropsParser implements Listener{

    private MagmasMobs plugin;

    public SuperDropsParser(Plugin plugin) {
    ...
    public void superDropParser()
    {
        ...
        for (String lootEntry : lootCount)
        {
            ...
            if (itemEnchantments != null)
            {
                ...
                getLogger().info(itemEnchantments + "");
    ...
    public void onDeath (EntityDeathEvent event)
    {
        ...
        if (entity.hasMetadata("NaturalEntity") &&
                ...
                entity.getMetadata("MagmasSuperMob").get(0).asInt() > 5)
        {
